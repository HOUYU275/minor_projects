...
public class SimpleTestFunctionTwo extends TestFunction {
    ...
    public SimpleTestFunctionTwo(int numberOfVariables, float[] minAntecedentRanges, float[] maxAntecedentRanges, float minConsequenceRange, float maxConsequenceRange) {

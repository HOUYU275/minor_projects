...
import hierarchicalharmonysearch.core.Harmony;
import hierarchicalharmonysearch.core.HarmonyComparator;
...
public class FeatureSelectionHarmonyComparator extends HarmonyComparator {
    ...
    public static BitSet toBitSet(Harmony harmony) throws Exception {
        //return null;
        //int numAttributes = harmony.getHarmonyMemory().getNumNotes();
        int numAttributes = (int) harmony.getHarmonyMemory().getSections()[0].getValueRange().getMax();

...
import weka.fuzzy.measure.Clause;
import weka.fuzzy.measure.FDM;
...
public class JohnsonReducer
    ...
    public final ArrayList<Clause> updateTrueByObject(ArrayList<Clause> CL, int
            highestIndex) {
        ...
        while (i.hasNext()) {
            t = i.next();
            if ((t.getObject1() != highestIndex) & (t.getObject2() != highestIndex))
    ...
    public final int heuristicPick(ArrayList<Clause> CL) {
        ...
        while (i.hasNext()) {
            ...
            if (t.setValues == 1) {
                ...
                for (int a = reduct.nextClearBit(0); a < m_numAttribs; a =
                        reduct.nextClearBit(a + 1)) {
        ...
        if (!unit) {
            ...
            for (int a = reduct.nextClearBit(0); a < m_numAttribs; a = reduct.nextClearBit(a
                    + 1)) {
    ...
    /**
     * Get the current degree of satisfaction of the Clause t based on the selected
     * attributes
     */

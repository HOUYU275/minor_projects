...
public class VQRS extends FuzzyMeasure  implements TechnicalInformationHandler {
	...
	public String globalInfo() {
		return "VQRS evaluator, using the vaguely quantified fuzzy rough lower approximations.\n\n"
		+ toString() + "\n\n" + getTechnicalInformation().toString();
	}

	public String toString() {
		return "VQRS: alpha="+alpha+" beta="+beta;
	}
}

...
public class DiscernibilityF extends FuzzyMeasure implements TechnicalInformationHandler {
	...
	public double calculate(BitSet reduct) {
		...
		for (int i = 0; i < m_numInstances - 1; i++) {
			for (int j = i + 1; j < m_numInstances; j++) {
				...
				//if (d==0) System.err.println(i+","+j);

				ret = m_TNorm.calculate(ret, d);
			}
		}
	...
	public String globalInfo() {
		...
		return "Discernibility function - f.\n\n"

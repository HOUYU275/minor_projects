 ...
 * @see weka.datagenerators.clusterers.SubspaceCluster
 */
public class SubspaceClusterDefinition 
   ...
   * @see weka.datagenerators.clusterers.SubspaceCluster#TAGS_CLUSTERTYPE
   */
   ...
   * @see weka.datagenerators.clusterers.SubspaceCluster#TAGS_CLUSTERSUBTYPE
   */

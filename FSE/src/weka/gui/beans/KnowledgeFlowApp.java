  ...
  public static synchronized void loadProperties() {
    if (BEAN_PROPERTIES == null) {
      ...
      try {
        ...
        Enumeration keys =
          (Enumeration)BEAN_PROPERTIES.propertyNames();
      ...
      if (VISIBLE_PERSPECTIVES == null) {
        ...
        try {
          ...
          Enumeration keys = (Enumeration)visible.propertyNames();
          if (keys.hasMoreElements()) {
...
/*      Vector components = 
        ...
        if (groupable) {
          ...
          for (int i = 0; i < inputs.size(); i++) {
            ...
            if (temp.getBean() instanceof Visible) {
              ...
              setDisplayConnectors(true, Color.red);
            }
          }
          ...
          for (int i = 0; i < outputs.size(); i++) {
            ...
            if (temp.getBean() instanceof Visible) {
              ((Visible)temp.getBean()).getVisual().
              setDisplayConnectors(true, Color.green);
            }
          }
  ...
  private void highlightSubFlow(int startX, int startY,
      int endX, int endY) {
    Rectangle r =
      new Rectangle((startX < endX) ? startX : endX,
  ...
  private void groupSubFlow(Vector selected, Vector inputs, Vector outputs) {
    ...
    Rectangle r = new Rectangle(upperLeftX, upperLeftY,

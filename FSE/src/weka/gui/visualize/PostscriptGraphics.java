...
public class PostscriptGraphics extends Graphics2D {
   ...
   * 
   * @see #drawImage(java.awt.Image,int,int,int,int, java.awt.Color, java.awt.image.ImageObserver)
   */
   ...
   * background color
   * 
   * @see #drawImage(java.awt.Image,int,int, java.awt.Color, java.awt.image.ImageObserver)
   ...
   * 
   * @see #drawImage(java.awt.Image,int,int,int,int,int,int,int,int, java.awt.Color, java.awt.image.ImageObserver)
   */

...
public class Instances extends AbstractList<Instance>
  ...
  */
   ...
   * @see #readInstance(java.io.Reader) */
   ...
   * @throws java.io.IOException if the ARFF file is not read
   * successfully
   */
   ...
   * @throws java.io.IOException if there is a problem with the reader.

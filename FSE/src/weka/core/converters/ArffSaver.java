...
public class ArffSaver 
   ...
   * @throws java.io.IOException        throws an IOException if destination cannot be set
   */
   ...
   * @throws java.io.IOException throws IOEXception if an instance cannot be saved incrementally.
   */  
   ...
   * @throws java.io.IOException throws IOException if saving in batch mode is not possible
   */

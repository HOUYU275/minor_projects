...
public class ArffLoader 
  ...
  public static class ArffReader
     ...
     * @throws java.io.IOException 	containing the error message
     */
     ...
     *
     * @throws java.io.IOException 	if reading the next token fails
     */
     ...
     *
     * @throws java.io.IOException 	if it finds a premature end of line
     */
     ...
     * @throws java.io.IOException 	if it doesn't find an end of line
     */
    ...
    public String getRevision() {
      return RevisionUtils.extract("$Revision: 7792 $");
    }
  }

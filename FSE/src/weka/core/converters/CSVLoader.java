...
public class CSVLoader 
   ...
   *
   * @return the structure of the data set as an empty set of Instances
   * @exception java.io.IOException if there is no source or parsing fails
   */
  @Override
   ...
   * @exception java.io.IOException always. CSVLoader is unable to process a data
   * set incrementally.
   */
  @Override
  ...
  public String getRevision() {
    return RevisionUtils.extract("$Revision: 7768 $");
  }

 ...
 * class.  
 *  
 * @see weka.core.xml.MethodHandler
 * @see weka.core.xml.XMLSerialization
 * 
...
public class XMLSerializationMethodHandler
    ...
    * @see weka.core.xml.XMLSerialization#readFromXML(org.w3c.dom.Element)
    */
    ...
    * @param name the name of the method to return
    * @return either <code>null</code> if no method was found or a reference 
    * @see weka.core.xml.XMLSerialization#writeToXML(org.w3c.dom.Element, Object, String)
    */

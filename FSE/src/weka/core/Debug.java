...
public class Debug
  ...
  public static class Clock 
    ...
    public String getRevision() {
      return RevisionUtils.extract("$Revision: 7517 $");
    }
  }
   ...
   * 
   * @see weka.core.Debug.Log
   * @see weka.core.Debug#writeToFile(String, String)
   * @see weka.core.Debug#writeToFile(String, String, boolean)
   */

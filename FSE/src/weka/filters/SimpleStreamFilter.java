 ...
 * @see     weka.filters.SimpleBatchFilter
 * @see     #input(weka.core.Instance)
 * @see     #batchFinished()
...
public abstract class SimpleStreamFilter
   ...
   * @see         #batchFinished()
   * @see         #setInputFormat(weka.core.Instances)
   * @see         #m_FirstBatchDone
   */
   ...
   * @see                   #batchFinished()
   * @see                   #preprocess(weka.core.Instances)
   */
   ...
   * @throws Exception  in case the processing goes wrong
   * @see               #batchFinished()
   * @see               #process(weka.core.Instance)
   */
   ...
   * @see               #hasImmediateOutputFormat()
   * @see               #determineOutputFormat(weka.core.Instances)
   */

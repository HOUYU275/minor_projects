...
import weka.fuzzy.unsupervised.UGamma;
...
public class UnsupervisedFRFS
    ...
    public UnsupervisedFuzzyMeasure m_FuzzyMeasure = new UGamma();
    ...
    public void setOptions(String[] options)
        ...
        if (optionString.length() != 0) {
            ...
            setFuzzyMeasure((UnsupervisedFuzzyMeasure) Utils.forName(UnsupervisedFuzzyMeasure.class, className, nnSearchClassSpec));
        } else {

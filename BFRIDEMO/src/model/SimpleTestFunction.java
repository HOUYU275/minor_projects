...
public class SimpleTestFunction extends TestFunction {
    ...
    public SimpleTestFunction(int numberOfVariables, double[] minAntecedentRanges, double[] maxAntecedentRanges, double minConsequenceRange, double maxConsequenceRange) {
